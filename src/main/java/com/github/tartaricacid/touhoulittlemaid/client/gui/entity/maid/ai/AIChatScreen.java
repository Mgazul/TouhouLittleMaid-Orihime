...
public class AIChatScreen extends Screen {
    ...
    protected void init() {
        ...
        this.input = new EditBox(Screens.getClient(this).fontFilterFishy, posX - 165, posY + 64,
        ...
        this.configButton = new FlatColorButton(posX + 142, posY + 58, 20, 20, Component.literal("✎"),
                b -> ClientPlayNetworking.send(new GetMaidAIDataPackage(this.maid.getId())))
    ...
    private void sendDoneMessage() {
        ...
        if (StringUtils.isNotBlank(value) && player != null) {
            ...
            ClientPlayNetworking.send(new SendUserChatPackage(this.maid.getId(), value, language));
