...
public class TankBackpackContainerScreen extends AbstractMaidContainerGui<TankBackpackContainer> implements IBackpackContainerScreen {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        MaidFluidRender.drawFluid(graphics, leftPos + 200, topPos + 108, 29, 50, maid.getBackpackFluid(), this.menu.getClientFluidAmount(), (int) TankBackpackData.CAPACITY);
        ...
        if (xInRange && yInRange) {
            ...
            MutableComponent fluidInfo = Component.translatable("tooltips.touhou_little_maid.tank_backpack.fluid",
                    MaidFluidRender.getFluidName(maid.getBackpackFluid(), this.menu.getClientFluidAmount() / 81),
                    this.menu.getClientFluidAmount() / 81).withStyle(ChatFormatting.GRAY);
