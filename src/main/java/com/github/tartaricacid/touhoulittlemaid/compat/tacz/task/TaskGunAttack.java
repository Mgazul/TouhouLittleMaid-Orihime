...
public class TaskGunAttack implements IRangedAttackTask {
    ...
    public ItemStack getIcon() {
        ...
        if (icon == null) {
            TimelessAPI.getCommonGunIndex(gunId).ifPresentOrElse(index -> this.icon = GunItemBuilder.create().setId(gunId)
                            .build(RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY)),
                    () -> this.icon = InitItems.TACZ_GUN_ICON.getDefaultInstance());
        }
        return this.icon;
    }
