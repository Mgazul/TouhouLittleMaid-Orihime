...
public class EntityBroom extends AbstractEntityFromItem implements OwnableEntity, HasCustomInventoryScreen {
    ...
    public void openCustomInventoryScreen(Player player) {
        ...
        if (hasPlayer) {
            if (maidOpen == null) {
                ServerPlayNetworking.send(serverPlayer, OpenPlayerInventoryMessage.ID, OpenPlayerInventoryMessage.encode(OpenPlayerInventoryMessage.OPEN_PLAYER_INVENTORY));
            } else {
