...
public final class InitDamage {
    ...
    public static void bootstrap(BootstapContext<DamageType> ctx) {
        ctx.register(DANMAKU, new DamageType("touhou_little_maid.danmaku", 0.1f, DamageEffects.HURT));
        ctx.register(DANMAKU_ENDER_KILLER, new DamageType("touhou_little_maid.danmaku", 0.1f, DamageEffects.HURT));
    }
}
