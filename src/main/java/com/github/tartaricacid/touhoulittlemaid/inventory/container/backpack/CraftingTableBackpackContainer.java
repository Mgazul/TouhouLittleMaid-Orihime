...
public class CraftingTableBackpackContainer extends MaidMainContainer {
    public static final MenuType<CraftingTableBackpackContainer> TYPE = new ExtendedScreenHandlerType<>(
            (id, inv, data) -> new CraftingTableBackpackContainer(id, inv, data.readInt())
    );
