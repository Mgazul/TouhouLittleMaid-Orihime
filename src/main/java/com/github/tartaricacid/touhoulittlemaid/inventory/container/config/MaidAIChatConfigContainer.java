...
public class MaidAIChatConfigContainer extends AbstractMaidContainer {
    public static final MenuType<MaidAIChatConfigContainer> TYPE = new ExtendedScreenHandlerType<>(MaidAIChatConfigContainer::create);
...
/*            @Override
    ...
    @NotNull
    private static MaidAIChatConfigContainer create(int windowId, Inventory inv, FriendlyByteBuf buf) {
